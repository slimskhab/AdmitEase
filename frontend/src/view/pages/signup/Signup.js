...
import { Radio, RadioGroup, Stack, useToast,Spinner } from '@chakra-ui/react';
    ...
    const handleSubmitClick = () => {
        ...
        if (isSelected) {
            ...
            if (isValid) {
                ...
                axios.post(`${process.env.REACT_APP_HOSTURL}/Teacher/signup`, requestData).then((response) => {
...
*/
    ...
    const postDetails = (pics) => {
        ...
        if (pics.type === "image/jpeg" || pics.type === "image/png") {
            ...
            data.append("upload_preset", "Teacher-consultation");
